...
(defvar html-helper-any-list-start
  "<dl\\|<ul\\|<ol\\|<form\\|<select\\|<table\\|<tr\\|<style\\|<div\\|{")
(defvar html-helper-any-list-end
  "</dl>\\|</ul>\\|</ol>\\|</form>\\|</select>\\|</table>\\|</tr>\\|</style>\\|\
</div>\\|}")
          ...
          (let ((m (point-marker))
            ...
            (let* ((where (html-helper-guess-prev-context))
              ...
              (if (looking-at html-helper-any-list)
                  (progn
                    ...
                    (cond
                     ...
                     ;; Start of list and last line beginning of item, forward
              ...
              (if (< (current-column) (current-indentation))
                  (back-to-indentation))))))
    ;; Indicate that buffer has not been modified, if that is the case
